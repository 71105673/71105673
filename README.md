...
|:---|:---|:---|:---|
| **VGA PK Game Project** <br> 📅(25.09.10 ~ 25.09.30) | 설명 | 대한상공회의소 | [Ronaldo_PK Project](https://github.com/71105673/Ronaldo_Project) |
...
| **AI Skin Doctor** <br> 📅(25.07.01 ~ 25.07.10) | - **Ai Skin Doctor**는 딥러닝과 LLM을 활용해 웹캠으로 사용자의 피부 병변을 분석 후 Ollama를 이용해 간결하고 실용적인 정보를 제공하는 스킨케어 시스템.<br> - **H5 모델을 ONNX, TFLite 모델을 사용해 더 빠르고 효율적으로 동작할 수 잇게 변환한 피부 질환 진단 시스템**. <br> - **범용성**을 고려하여 LLM 기반 **AI 가이드** 가능성을 검증. | 대한상공회의소 | [AI Skin Doctor](https://github.com/71105673/Project_skindoctor) |
...
| **PWM Microwave** <br> 📅(25.06.20 ~ 25.06.22) | - Basys3 FPGA 보드와 DC 모터, L298N 모터 드라이버를 활용하여 전자레인지를 구현한 프로젝트입니다.<br> - PWM 기반 모터 제어와 FSM 설계를 통해 실제 전자레인지 동작(시간 설정, 시작, 동작, 종료)을 FPGA 상에서 재현했습니다. | 대한상공회의소 | [PWM_Microwave](https://github.com/71105673/PWM_MicroWave) |
...
| **근사 가산기를 이용한 저전력 디지털 신호 처리** <br> 📅(24.02.12 ~ 24.06.28)  | - Cadence Virtuoso 및 Python을 활용한 프로젝트 수행 <br> - 모바일 기기, IoT 확산 → 저전력 연산 중요성 증가 <br> - 이미지 프로세싱은 데이터량이 많아 전력 소모 큼 <br> - 정밀 가산기(FA)는 정확하지만 전력 소모 ↑ <br> - 근사 가산기(Approximate Adder) → 약간의 오류를 허용하고 전력/면적 효율 개선 <br> 5가지 근사 가산기를 적용한 모듈을 설계하여 PPA 및 PSNR을 측정| 인하대학교 <br> (정보통신공학과) | [근사 가산기를 활용한 저전력 디지털 신호처리](https://github.com/71105673/Low-Power-Digital-Signal-Processing-Using-Approximate-Adders) |
