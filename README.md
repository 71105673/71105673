...
| **2Stage 16bit MultiPlier** <br> 📅(24.05.30 ~ 25.06.20)  | - Cadence Virtuoso를 활용해 **Schematic → Layout** 전 과정을 수행 <br> - **Wallace Tree 구조** 기반으로 Multiplier 설계 및 검증 <br> - 2.2GHz 동작속도를 달성 | 인하대학교 <br> (정보통신공학과) | 링크|
