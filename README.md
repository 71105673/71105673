...
|:---|:---|:---|:---|
| **RISC-V AMBA APB** <br> 📅(25.08.26 ~ 25.08.29) | - RISC-V Multi-Cycle CPU와 저전력/저속 통신을 위한 AMBA APB (Advanced Peripheral Bus) 프로토콜을 활용 - 주변장치(Peripheral)를 설계하고 검증 | 대한상공회의소 | [RISC-V / AMBA_APB](https://github.com/71105673/RISC-V/tree/main/AMBA_APB) |
...
| **루팡:경찰과 도둑** <br> 📅(25.04.25 ~ 25.05.02) | - **ARM Cortex-M3** 기반의 마이크로컨트롤러에서 게임 로직 구현 및 하드웨어 데이터시트 기반 레지스터 직접 제어
- 타이머, GPIO, PWM, 인터럽트 등 데이터시트를 참고하여 필요한 레지스터 비트를 직접 활성화하고 활용
- 임베디드 환경에서 레지스터 제어와 인터럽트 기반 프로그래밍 이해 | 대한상공회의소 | [ARM_Cortex-M3](https://github.com/71105673/ARM_Cortex-M3) |
